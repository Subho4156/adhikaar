...
const basicFormSchema = z.object({
  ...
  phone: z
    .string()
    .regex(/^(\+?\d{1,4}?)?\d{9,10}$/, "Invalid phone number format."),
});
...
const CameraModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="rounded-none max-w-md w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="p-4">
          <div
            className="relative bg-gray-900 rounded-none overflow-hidden mb-4"
    ...
    if (isFullKYC) {
      ...
      if (missingDocs.length > 0) {
        toast({
          ...
          description:
            "Please capture and upload all required documents for full KYC verification.",
          variant: "destructive",
        });
        return;
      }
      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : "Failed to complete VKYC. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
    ...
    <div className="min-h-screen">
      ...
      <div className="pt-24 px-4 py-8">
          ...
          <Card className="bg-transparent shadow-none">
            <CardHeader className="text-center">
              <div className="flex items-center justify-center space-x-2 mb-4">
                <div className="bg-gradient-to-r from-slate-700 to-slate-900 p-2 rounded-none">
              ...
              {isFullKYC && (
                <div className="flex items-center justify-center space-x-2 mt-2 p-2 bg-blue-50 rounded-none">
        ...
        <CameraModal
          ...
          title={`Capture ${
            showCamera
              ? showCamera.charAt(0).toUpperCase() + showCamera.slice(1)
              : ""
          }`}
        />
      </div>
