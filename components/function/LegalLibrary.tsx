      ...
      if (response.ok) {
        ...
        if (response.status >= 500) {
          toast({
            ...
            description:
              "Unable to load documents at the moment. Please try again later.",
            variant: "destructive",
          });
        }
      }
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Comprehensive collection of legal documents, case laws, and
              reports from verified professionals
            </p>
          </div>
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="flex items-center space-x-2">
                  <select
                    ...
                    className="px-3 py-2 border cursor-pointer bg-primary text-sm text-background focus:outline-none"
                  >
                  ...
                  <CardContent>
                    ...
                    <div className="mt-3 pt-3 border-t border-slate-200">
                      <div className="flex justify-between items-center text-xs text-slate-500">
                        ...
                        {doc.date && (
                          <span>
                            Case Date: {new Date(doc.date).toLocaleDateString()}
                          </span>
                        )}
                      </div>
                    </div>
